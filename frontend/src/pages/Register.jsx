                ...
                <form className="auth-form" onSubmit={handleSubmit} id="register-form">
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                        ...
                        <div className="form-group">
                            ...
                            <input id="reg-confirm" type="password" name="confirm_password" placeholder="Repeat password"
                                value={form.confirm_password} onChange={handleChange} required />
                        </div>
                    </div>

                    <button className="btn-primary" type="submit" id="register-btn" disabled={loading}>
